        ...
        if clean_prompt:
            try:
                ...
                if "kamel" in full_text or "kamelabdul" in message.author.name.lower():
                    model = genai.GenerativeModel("gemini-pro", system_instruction=system_instruction_kamel)
                else:
                    model = genai.GenerativeModel("gemini-pro", system_instruction=system_instruction_normal)
